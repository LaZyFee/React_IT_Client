...
export const HireBest = () => {
  ...
  const handleUnauthenticatedClick = () => {
    Swal.fire({
      ...
      text: "Please sign in to hire elite developers.",
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <div className="relative inline-block">
                <button
                  onClick={
                    user ? () => setShowModal(true) : handleUnauthenticatedClick
                  }
                  disabled={!user}
                  className={`group relative px-8 py-4 ${
                    user
                      ? "bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 hover:bg-primary hover:text-white"
                      : "bg-gray-400 cursor-not-allowed"
                  } text-white font-bold text-lg rounded-2xl shadow-2xl transition-all duration-300`}
                >
                  <span className="relative z-10 flex items-center gap-3">
                    <Users className="w-6 h-6" />
                    {user ? "Hire Elite Developer" : "Sign In to Hire"}
                    <ArrowRight
                      className={`w-5 h-5 transition-transform ${
                        user ? "group-hover:translate-x-1" : ""
                      }`}
                    />
                  </span>
                  {user && (
              ...
              <p className="text-sm text-gray-400 mt-4">
                {user
                  ...
                  : "🔐 Please sign in to access our talent pool"}
              </p>
            </div>
